...
def count_letters(text: str) -> dict:
    ...
    пример:
        ...
        'е': 1, 'ё': 1, 'н': 1, 'ы': 1, 'й': 1}
    """
    # Очищаем текст: только буквы в нижнем регистре.
    text = ''.join(char for char in text if char.isalpha()).lower()

    # Используем объект Counter для подсчёта уникальных букв и их количества.
...
def calculate_frequency(letter_count: dict) -> dict:
    ...
    """
    # Вычисляем общую сумму всех букв.
    total_letters = sum(letter_count.values())

    # Создаём новый словарь для частот (чтобы не менять оригинал).
    new_total_letters = {}
